  ...
  return (
    <>
      ...
      <div className="about py-10  mx-5 md:mx-24 lg:mx-32 xl:mx-40">
        ...
        <h2 className="text-3xl font-semibold mb-5 text-[#FF00FF]">
          A bit about me
        </h2>
        <p className="text-lg">
          I am a self-taught web developer, resilience in nature, focused on
          utilizing my technical skills like the popular JavaScript library,
          React to build an amazing UI, high performance, and responsive
          website, and also making use of the CSS framework, TailwindCSS for
          simplicity. I take into consideration the user experience while
          writing reusable and efficient code.
        </p>
        <h2 className="text-3xl font-semibold my-5 text-[#FF00FF]">
          Tools and Technology Stacks
        </h2>
        <p className="text-lg">
          Making use of varieties of tools and technology enhances my ability to
          provide responsive and efficient website for users using different
        ...
        <div className="education">
          <h2 className="text-3xl font-semibold mt-8 text-[#FF00FF]">
            Education
          </h2>
